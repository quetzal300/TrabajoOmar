...
@Component({
  selector: 'app-editar-publi-home',
  templateUrl: './editar-publi-home.component.html',
  styleUrls: ['./editar-publi-home.component.css']
})
export class EditarPubliHomeComponent implements OnInit {
  ...
  guardar(formu: NgForm,archivo:FileItem[]){
    ...
    if(formu.invalid){
      ...
      if(archivo.length!==0){
        ...
        this.publicidad.actualizar(this.Publisidad,localStorage.getItem('id')).subscribe(respuesta =>{
