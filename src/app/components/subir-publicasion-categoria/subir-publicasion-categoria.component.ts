...
@Component({
  selector: 'app-subir-publicasion-categoria',
  templateUrl: './subir-publicasion-categoria.component.html',
  styleUrls: ['./subir-publicasion-categoria.component.css']
})
export class SubirPublicasionCategoriaComponent implements OnInit {
  ...
  cargaImagen(archivo:FileItem[],Publisidad){
    return this.cargaImg.cargarImagenAFirebeC(archivo,Publisidad);
  }
